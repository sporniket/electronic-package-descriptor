...
def test_Directionnality():
    assert(PinDescription('C5','CLK','PWR','Main clock').directionnality == Directionnality.IN)
    assert(PinDescription('C5','CLK','GND','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','DNC','Main clock').directionnality == None)
    assert(PinDescription('C5','CLK','I','Main clock').directionnality == Directionnality.IN)
    assert(PinDescription('C5','CLK','ICLK','Main clock').directionnality == Directionnality.IN)
    assert(PinDescription('C5','CLK','O','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','OCLK','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','O3','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','OCOL','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','OEMT','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','OPSV','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','OPWR','Main clock').directionnality == Directionnality.OUT)
    assert(PinDescription('C5','CLK','B3','Main clock').directionnality == Directionnality.BI)
    assert(PinDescription('C5','CLK','B','Main clock').directionnality == Directionnality.BI)
